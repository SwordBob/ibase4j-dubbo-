...
public class SysAuthorizeController extends AbstractController<ISysProvider> {
    ...
    public Object getUserMenu(ModelMap modelMap, @RequestBody SysUserMenu param) throws Exception {
    ...
    public Object userMenu(ModelMap modelMap, @RequestBody List<SysUserMenu> list) throws Exception {
        Long userId = null;
