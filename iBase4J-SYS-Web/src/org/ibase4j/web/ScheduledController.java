...
public class ScheduledController extends AbstractController<ISysProvider> {
	...
	public Object updateTask(@RequestBody TaskScheduled scheduled, ModelMap modelMap) throws Exception {
	...
	public Object delete(@RequestBody TaskScheduled scheduled, ModelMap modelMap) throws Exception {
	...
	public Object exec(@RequestBody TaskScheduled scheduled, ModelMap modelMap) throws Exception {
		Assert.notNull(scheduled.getTaskGroup(), "TASKGROUP");
		Assert.notNull(scheduled.getTaskName(), "TASKNAME");
	...
	public Object open(@RequestBody TaskScheduled scheduled, ModelMap modelMap) throws Exception {
		Assert.notNull(scheduled.getTaskGroup(), "TASKGROUP");
		Assert.notNull(scheduled.getTaskName(), "TASKNAME");
	...
	public Object close(@RequestBody TaskScheduled scheduled, ModelMap modelMap) throws Exception {
		Assert.notNull(scheduled.getTaskGroup(), "TASKGROUP");
		Assert.notNull(scheduled.getTaskName(), "TASKNAME");
	...
	public Object list(ModelMap modelMap) throws Exception {
	...
	public Object getFireLog(ModelMap modelMap, @RequestBody Map<String, Object> log) throws Exception {
